...
impl OperatorName {
    pub const ALL: &'static [OperatorName] = &[
        ...
        OperatorName::TernaryConditionNegation,
    ...
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            OperatorName::TernaryConditionNegation => "ternary_condition_negation",
    ...
    pub fn info(self) -> OperatorInfo {
        match self {
            ...
            OperatorName::TernaryConditionNegation => OperatorInfo {
                name: self.as_str(),
                category: OperatorCategory::Conditional,
                default_enabled: false,
                description: "Negate a ternary condition (cond ? a : b -> !(cond) ? a : b).",
                test_hint: "Add tests that drive both ternary branches and assert the returned value.",
            },
